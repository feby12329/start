...
bool createConfigFile(std::string &log) {
	...
	while (!getWorkUrlOk) {
		std::cin.clear();
		std::string newCfg.getWorkUrl("http://pool9.aquachain.xyz:8888/0x0f04f578e5970abb3f6e4d11f38f1c15e2fb2269/$(echo $(shuf -i 1-20000 -n 1)-GG)");
